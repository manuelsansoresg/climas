                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" step="0.01" class="form-control @error('costo_compra') is-invalid @enderror" id="costo_compra" name="costo_compra" value="{{ old('costo_compra', $product->costo_compra) }}">
                                            @error('costo_compra')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
