                                    ...
                                    @if (auth()->user()->hasRole('Admin'))
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('client_type') is-invalid @enderror"
                                                ...
                                                <option value="Cliente publico en general"
                                                    {{ old('client_type') == 'Cliente publico en general' ? 'selected' : '' }}>
                                                    Cliente mayorista</option>
                                                <option value="Cliente instalador"
                                                    {{ old('client_type') == 'Cliente instalador' ? 'selected' : '' }}>
                                                    Cliente instalador</option>
                                            </select>
                                            @error('client_type')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
